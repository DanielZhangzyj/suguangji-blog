...
// demo 风格字符墙 —— 重着色为蓝族 + 浅蓝面板，贴合本站的「蓝+浅」调色板，不引入紫色。
const LetterGlitch = ({
  glitchColors = ["#1d4ed8", "#3b82f6", "#60a5fa"],
  glitchSpeed = 33,
  ...
  return (
    <div className="letter-glitch">
      ...
      {outerVignette && <div className="letter-glitch__vignette" />}
